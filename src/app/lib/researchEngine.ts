...
const FALLBACK_RESEARCH: ResearchPaper[] = [
  ...
  },
  {
    ...
    title: "Measuring Behaviour Change After Targeted Security Training",
    authors: ["Digital Risk Academy"],
    affiliation: "Digital Risk Academy",
    year: 2026,
    venue: "Research Brief",
