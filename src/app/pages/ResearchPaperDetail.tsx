...
import { ArrowLeft, ExternalLink, Landmark, ShieldAlert, ShieldCheck } from "lucide-react";
import {
  getPaperById,
  type ResearchDomain,
  type ResearchPaper,
        ...
        <article className="mt-6 bg-white rounded-3xl overflow-hidden border border-slate-200 shadow-[0_20px_60px_rgba(15,23,42,0.35)]">
          ...
          <div className="p-6 sm:p-8 md:p-10">
            ...
            <div className="mt-8">
              ...
              >
                {paper.venue === "Imperial College London"
                  ? "Open at Imperial College London"
